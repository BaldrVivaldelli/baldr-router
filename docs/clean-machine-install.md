...
1. Install the `baldr-router-vscode-0.16.1.vsix`, or install Baldr Router from the Marketplace when published.
2. Accept VS Code's publisher and MCP trust dialogs.
3. Open a Git repository.
4. Run `Baldr: Open`, then choose **Setup**, or enter `@baldr /setup`.
