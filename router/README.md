...
La línea v0.20 conserva este hardening y suma agentes externos políglotas sin ampliar la superficie MCP congelada:
...
La línea v0.20 está bajo feature freeze. Ver `../FEATURE_FREEZE.md`.
